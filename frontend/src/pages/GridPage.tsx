...
const DRIVERS = [
  ...
  { id: 13, name: "Colton Herta", team: "Cadillac F1 Team", number: "26", nationality: "American", helmetColor: "#FFFFFF" },
  { id: 14, name: "Alex Palou", team: "Cadillac F1 Team", number: "10", nationality: "Spanish", helmetColor: "#FFFFFF" },
